...
namespace SupportBot
{
	public static class SupportBot
	{
		...
		public static async Task AddAdminCommand(CommandArguments args)
		{
			...
			Data.Tickets.Add(new Ticket(id) { State = ETicketState.WAIT_IN_QUEUE });
		...
		[Command("^opentickets", "opentickets", "Get open ticket count")]
		public static async Task OpenTickets(CommandArguments args)
		{
			Logger.Info($"There are {Data.OpenTickets.Count()} open tickets");
		}
	}
}
